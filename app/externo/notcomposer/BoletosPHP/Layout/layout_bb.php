    ...
    <div id="container">
        ...
        <div id="boleto">
            ...
            <div id="instr_header">
                ...
                <ol>
                    <li>
                        ...
                        <span class="notice">Por favor, configure margens esquerda e direita
                            para 17mm.</span>
                    </li>
                    <li>
            ...
            <table class="header" border=0 cellspacing="0" cellpadding="0">
                <tbody>
                <tr>
                    <td width=150><IMG src=<?php echo $dadosboleto['pasta_imagens'].'logobb.jpg' ?>></td>
                    <td width=50>
            ...
            <table cellspacing=0 cellpadding=0 width=666 border=0>
                <TBODY>
                <TR>
                    <TD width=666 align=right><font style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica -
                            Ficha de Compensação</font></TD>
                </tr>
                </tbody>
            </table>
            <div class="barcode">
