...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width=160 class=cp><img src=<?php echo $dadosboleto['pasta_imagens'].'/logosudameris.jpg' ?>  alt="Sudameris" width="150" height="27"></td>
	...
	<tr><td colspan=5><img height=1 src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=750></td></tr>
</table>
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width=7 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=7 height=1></td>
		<td width=112><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=112 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=7 height=1></td>
		<td width=113><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=113 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=7 height=1></td>
		<td width=53><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=53 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=7 height=1></td>
		<td width=53><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=53 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=7 height=1></td>
		<td width=113><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=113 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=7 height=1></td>
		<td width=180><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=180 height=1></td>
	</tr>
	<tr>
	...
	<tr><td colspan=12 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=750 height=1></td></tr>
	<tr>
		<td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		...
		<td width=564 class=ct>setDemonstrativo</td>
	...
	<tr><td colspan=4><img src=<?php echo $dadosboleto['pasta_imagens'].'/6.png' ?>  width=665 height=1></td></tr>
</table>
&nbsp;<br>
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
...
<table cellspacing=0 cellpadding=0 border=0 height="2">
	<tr>
		<td width=7 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=100><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=100 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=74><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=74 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=73><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=73 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=55><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=55 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=35><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=35 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=100><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=100 height=1></td>
		<td width=7><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td>
		<td width=180><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=180 height=1></td>
	</tr>
	<tr>
		<td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
	...
	<tr><td colspan=14 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=750 height=1></td></tr>
	<tr>
		<td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		<td width=7 height=26><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=26></td>
	...
	<tr><td height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=1 height=1></td><td><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td><td><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=180 height=1></td></tr>
	<tr>
	...
	<tr><td height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=1></td><td><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=7 height=1></td><td><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=180 height=1></td></tr>
	<tr>
		<td height=26><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=26></td>
		<td><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=1 height=26></td>
	...
	<tr><td colspan=4 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=750 height=1></td></tr>
	<tr>
		<td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr><td colspan=2 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/6.png' ?>  width=665 height=1></td></tr>
</table>
</body>
