...
#instr_header {
	background: url("<?php echo $dadosboleto['pasta_imagens'].'/logo_empresa.png'?>") no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
<!--
 ...
 -->
	...
	<div id="boleto">
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?php echo $dadosboleto['pasta_imagens'].'/logobancoob.jpg'?>"></td>
			<td width=50>
