    ...
    <page size="A4">
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tr>
                <td width=140 class=cp><img src=<?php echo $dadosboleto['pasta_imagens'].'/logocaixa.jpg' ?>  alt="Sicredi" width="150" height="27"></td>
            ...
            <tr><td colspan=5><img height=1 src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=666></td></tr>
        </table>
        <table cellspacing=0 cellpadding=0 border=0>
            <tr>
            ...
            <tr><td colspan=12 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=666 height=1></td></tr>
            <tr>
                <td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
        ...
        <table cellspacing=0 cellpadding=0 border=0 height="2">
            ...
            <tr><td colspan=14 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=666 height=1></td></tr>
            <tr>
                <td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            ...
            <tr><td colspan=4 height=1><img src=<?php echo $dadosboleto['pasta_imagens'].'/2.png' ?>  width=666 height=1></td></tr>
            <tr>
                <td height=13><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=13></td>
