...
<page size="A4">
    ...
    <table width="750" cellspacing=0 cellpadding=0 border=0>
        <tr>
            <td width=140 class=cp><img src=<?php echo $dadosboleto['pasta_imagens'].'/logosantander.jpg' ?>  alt="Sicredi" width="150" height="27"></td>
    ...
    <table width="750" cellspacing=0 cellpadding=0 border=0>
        ...
        <tr>
            ...
            <td class=cp>  <?php $tmp2 = $dadosboleto["codigo_cliente"];
               $tmp2 = substr($tmp2,0,strlen($tmp2)-1).'-'.substr($tmp2,strlen($tmp2)-1,1);
                ?>

                <?php echo $dadosboleto["ponto_venda"]." <img src='imagens/b.png' ?> ' width=10 height=1> ".$tmp2?></td>
            <td><img src=<?php echo $dadosboleto['pasta_imagens'].'/1.png' ?>  width=1 height=12></td>
